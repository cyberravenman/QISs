...
from src.TAB_6.Factors import Multicolleniarnost, VIF, Corrcoefficient
...
class mywindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.ui.pushButton_TAB6_Multicolleniarnost.clicked.connect(self.btnClicked_Logit_Multicollinearnost)
        self.Multicollinearnost_process = Multicolleniarnost()

        self.ui.pushButton_TAB6_Corrcoefficient_matrix.clicked.connect(self.btnClicked_Logit_Corrcoefficient)
        self.Corrcoefficient_process = Corrcoefficient()

        self.ui.pushButton_TAB6_VIF.clicked.connect(self.btnClicked_Logit_VIF)
        self.VIF_process = VIF()
    ...
    def btnClicked_Logit_Multicollinearnost(self):
        ...
        current_date = date.today()
        path_to_result = os.path.expanduser("~") + "/Documents/QISs/LogitModel/Collinearnost/" + str(current_date)

        self.Multicollinearnost_process.path_for_csv = self.ui.lineEdit_TAB6_Path_to_csvFile.text()
        self.Multicollinearnost_process.path_for_result = path_to_result
        self.Multicollinearnost_process.name_of_file = self.ui.lineEdit_TAB6_Multicoll_name_output.text()
        self.Multicollinearnost_process.list_widget_csv = self.ui.listWidget_TAB6_csvHeaders

        self.Multicollinearnost_process.start()  
        self.Multicollinearnost_process.finished.connect(self.onFinished_Factors)  

    def btnClicked_Logit_Corrcoefficient(self):
        ...
        current_date = date.today()
        path_to_result = os.path.expanduser("~") + "/Documents/QISs/LogitModel/CorrCoef/" + str(current_date)

        self.Corrcoefficient_process.path_for_csv = self.ui.lineEdit_TAB6_Path_to_csvFile.text()
        self.Corrcoefficient_process.path_for_result = path_to_result
        self.Corrcoefficient_process.name_of_file = self.ui.lineEdit_TAB6_Corrcoef_name_output.text()
        self.Corrcoefficient_process.list_widget_csv = self.ui.listWidget_TAB6_csvHeaders

        self.Corrcoefficient_process.start()  
        self.Corrcoefficient_process.finished.connect(self.onFinished_Factors)  

    def btnClicked_Logit_VIF(self):
        ...
        current_date = date.today()
        path_to_result = os.path.expanduser("~") + "/Documents/QISs/LogitModel/VIF/" + str(current_date)

        self.VIF_process.path_for_csv = self.ui.lineEdit_TAB6_Path_to_csvFile.text()
        self.VIF_process.path_for_result = path_to_result
        self.VIF_process.name_of_file = self.ui.lineEdit_TAB6_VIF_name_output.text()
        self.VIF_process.list_widget_csv = self.ui.listWidget_TAB6_csvHeaders

        self.VIF_process.start()  
        self.VIF_process.finished.connect(self.onFinished_Factors)  
