...
def Calc_QRNG_Simulator(user_token, ibm_channel, shots, alpha, opt_level, num_of_qubits, usr_qubits):
    ...
    for i in range(0, USER_QUBITS_AND_CLBITS):
        ...
        if i == 0:
            ...
            file_name_good_q = PATH_TO_PROJECT_QIS + "QRNG/QRNG_SIMULATOR/good_qubits.txt"
            file_name_bad_q = PATH_TO_PROJECT_QIS + "QRNG/QRNG_SIMULATOR/bad_qubits.txt"
            ...
            file_name_cnt_q = path_for_stats_counts + "cnt_stats.txt"
