...
from src.TAB_2.Gen_Scheme import GenerateScheme
from src.gui import Ui_MainWindow
from src.TAB_1.QPU_Info import *
from src.TAB_2.IDLE_INIT_H import *
from src.TAB_2.JobID import *
from src.TAB_3.QRNG import *
from src.TAB_3.QRNG_Simulator import *
from src.TAB_3.JobID import *
import subprocess
import sys
...
class mywindow(QtWidgets.QMainWindow):
    ...
    def btnClicked_TAB2_Gen_Scheme(self):
        ...
        self.TAB2_Generate_Scheme.shots = self.ui.lineEdit_TAB2_Shots.text()                    
        self.TAB2_Generate_Scheme.alpha = self.ui.lineEdit_TAB2_Alpha.text()                    
        self.TAB2_Generate_Scheme.opt_level = self.ui.lineEdit_TAB2_OptLevel.text()             
    ...
    def btnClicked_TAB2_JobID_Download(self):
        ...
        self.Download_JobID_TAB2.alpha = self.ui.lineEdit_ALPHA.text()           
    ...
    def btnClicked_QRNG_Start(self):
        ...
        self.ui.lineEdit_QRNG_Shots.setEnabled(False)                   
        self.ui.lineEdit_ALPHA.setEnabled(False)                        
        self.ui.lineEdit_QRNG_OptLevel.setEnabled(False)                
    ...
    def onFinished_QRNG(self):  
        ...
        self.ui.lineEdit_QRNG_Shots.setEnabled(True)                   
        self.ui.lineEdit_ALPHA.setEnabled(True)                        
        self.ui.lineEdit_QRNG_OptLevel.setEnabled(True)                
    ...
    def btnClicked_NIST_Start(self):
        ...
        self.ui.pushButton_QRNG_Clear_Output.setEnabled(False)      

        QApplication.setOverrideCursor(Qt.WaitCursor)

        print("-----ПРОВЕРКА ПОСЛЕДОВАТЕЛЬНОСТЕЙ ТЕСТАМИ NIST STS-----\n")

        bash_command = "./NIST/auto_test_v.2.2.sh"
        ...
        self.ui.pushButton_QRNG_Clear_Output.setEnabled(True)           
